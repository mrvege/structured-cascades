...
public class RunFig {
    ...
    public static void setObjectProperty(Object o, String propertyName, Object value) {
        ...
        if ( m != null ) {
            try {
                ...
                throw new RuntimeException("Can't set property "+propertyName+" using method set"+methodSuffix+
            ...
            try {
                ...
                try {
                    ...
                    throw new RuntimeException("Can't access property "+propertyName+" using direct field access from "+
                            c.getName()+" instance: "+ iae);
                }
            }
            catch (NoSuchFieldException nsfe) {
                throw new RuntimeException("Class "+c.getName()+" has no such property/field: "+propertyName+
                    ": "+nsfe);
            }
        }
    }
    ...
    protected static Object newInstance(String name) {
    	...
    	//name = "spst.CascadeTagger$Options";
